export default function About() {
  return (
    <div style={{ display: "grid", gap: 24, textAlign: "center" }}>
      ...
      <h1 style={{ fontSize: 32, fontWeight: 800, marginTop: 16 }}>About Mahlet & Ferew Rentals</h1>
      <p style={{ maxWidth: 700, margin: "0 auto", color: "#333", fontSize: 16, lineHeight: 1.6 }}>
        We’re a small, family-run rental in Germantown’s Waters Landing community. This portal lets you pay rent,
        submit maintenance, and renew your lease online.
      </p>
